...
My research centers on **responsible (multimodal) generative models**, i.e., the security and intellectual property (IP) protection of generative AI. I study how the misuse of data and models can be detected, verified, and defended against in the era of generative models, spanning offensive (red-teaming), defensive (safety alignment and data protection), and auditing (provenance and ownership verification) perspectives.
